...
<body class="bg-slate-100 min-h-screen p-6">
    <div class="max-w-3xl mx-auto bg-white rounded-xl shadow p-8">
        <h1 class="text-2xl font-bold mb-6">Registrar inscripción</h1>
        ...
        <form method="POST" action="{{ route('inscripciones.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="grado" class="w-full border rounded-lg p-2" required>
                </div>
                <div>
                    <label class="block mb-1 font-medium">Curso</label>
                    <input type="text" name="curso" class="w-full border rounded-lg p-2" required>
                </div>
                <div>
                    <label class="block mb-1 font-medium">Fecha de inscripción</label>
                    <input type="date" name="fecha_inscripcion" class="w-full border rounded-lg p-2" required>
                </div>
                <div>
